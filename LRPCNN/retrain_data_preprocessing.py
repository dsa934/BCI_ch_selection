...
class EEG_train_dataset(Dataset):
    ...
    def __init__(self):
        ...
        x_train = scio.loadmat('cv_data/ch6/stft_aw/train/ch6_aw_train_1', squeeze_me=True)
        y_train = scio.loadmat('cv_data/ch6/stft_aw/train/train_label_1', squeeze_me=True)


        # extract signal only
        x_train = x_train['eeg_train']
...
class EEG_val_dataset(Dataset):
    ...
    def __init__(self):       
        ...
        x_val = scio.loadmat('cv_data/ch6/stft_aw/val/ch6_aw_val_1', squeeze_me=True)
        y_val = scio.loadmat('cv_data/ch6/stft_aw/val/val_label_1', squeeze_me=True)
...
class EEG_test_dataset(Dataset):
    ...
    def __init__(self):       
        ...
        x_test = scio.loadmat('cv_data/ch6/stft_aw/test/ch6_aw_test_1', squeeze_me=True)
        y_test = scio.loadmat('cv_data/ch6/stft_aw/test/test_label_1', squeeze_me=True)

        # extract signal only
        #x_test = x_test['freq_reduced_xtest']
        
        x_test = x_test['eeg_test']
