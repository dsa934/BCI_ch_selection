%{
Replicated CCS-CSP (by Jinwoo Lee)
...
clear all
load('./data_csp/av/train/train_1')
load('./data_csp/av//test/test_1')
load('./data_csp/av/train/train_label_1')
load('./data_csp/av/test/test_label_1')
...
csp_filter = jw_csp(bp_eeg_train);
csp_test_filter = jw_csp(bp_eeg_test);
